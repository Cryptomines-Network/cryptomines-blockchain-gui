import { useOpenFullNodeConnectionMutation } from '@cryptomines-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@cryptomines-network/core';
