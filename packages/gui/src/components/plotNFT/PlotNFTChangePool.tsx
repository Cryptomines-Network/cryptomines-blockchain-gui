import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@cryptomines-network/api-react';
import { Flex, State, Loading, StateTypography } from '@cryptomines-network/core';
