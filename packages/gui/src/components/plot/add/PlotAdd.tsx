import { useGetLoggedInFingerprintQuery, useGetPlottersQuery } from '@cryptomines-network/api-react';
import { useCurrencyCode, Suspender } from '@cryptomines-network/core';
