import { useGetHarvesterQuery } from '@cryptomines-network/api-react';
import { Accordion, Flex, FormatBytes, Tooltip, FormatLargeNumber } from '@cryptomines-network/core';
