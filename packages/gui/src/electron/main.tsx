      ...
      submenu: [
        {
          ...
          click: () => {
            openExternal('https://github.com/LloydMontgomeryGarmadon/chia-blockchain/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/LloydMontgomeryGarmadon/chia-blockchain/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/LloydMontgomeryGarmadon/chia-blockchain/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/LloydMontgomeryGarmadon/chia-blockchain/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/LloydMontgomeryGarmadon/chia-blockchain/issues');
          },
        },
        {
