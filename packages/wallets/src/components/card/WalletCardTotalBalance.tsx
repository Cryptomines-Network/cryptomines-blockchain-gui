import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@cryptomines-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@cryptomines-network/core';
